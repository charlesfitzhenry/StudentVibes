...
namespace StudentVibes.Admin
{
    public partial class AdminPage : System.Web.UI.Page
    {
        ...
        public IQueryable GetCategories()
        {
            ...
            IQueryable query = _db.Categories; return query;
        }
        public IQueryable GetProducts()
        {
            var _db = new StudentVibes.Models.ProductContext();
            IQueryable query = _db.Products; return query;
        }
        protected void RemoveProductButton_Click(object sender, EventArgs e)
        {
            using (var _db = new StudentVibes.Models.ProductContext())
            {
                ...
                if (myItem != null)
                {
                    _db.Products.Remove(myItem); _db.SaveChanges();
                    // Reload the page. 
                    string pageUrl = Request.Url.AbsoluteUri.Substring(0, Request.Url.AbsoluteUri.Count() - Request.Url.Query.Count());
