<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="StudentVibes.Admin.AdminPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownAddCategory" runat="server" ItemType="StudentVibes.Models.Category" SelectMethod="GetCategories" DataTextField="CategoryName" DataValueField="CategoryID"></asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="StudentVibes.Models.Product" SelectMethod="GetProducts" AppendDataBoundItems="true" DataTextField="ProductName" DataValueField="ProductID"></asp:DropDownList>
            </td>
        </tr>
    </table>
    <p></p>
